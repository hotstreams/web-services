...
import ifmo.webservices.lab6.exceptions.UnknownProductParameterException;
    ...
    public List<Product> getProducts(final Map<String, String> args) {
        ...
        for (Map.Entry<String, String> entry : args.entrySet()) {
            switch (entry.getKey()) {
                ...
                default -> throw new UnknownProductParameterException("Unknown parameter " + entry.getKey());
            }
        }
