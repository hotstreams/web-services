...
public class MissingFieldsException extends Exception {
    ...
    public MissingFieldsException(String message, ProductServiceFault fault) {
        super(message);
        this.fault = fault;
    }

    public MissingFieldsException(String message, ProductServiceFault fault, Throwable cause) {
        super(message, cause);
        this.fault = fault;
    }
