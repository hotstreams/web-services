...
public class ProductUpdateException extends Exception {
    ...
    public ProductUpdateException(String message, ProductServiceFault fault) {
        super(message);
        this.fault = fault;
    }

    public ProductUpdateException(String message, ProductServiceFault fault, Throwable cause) {
        super(message, cause);
        this.fault = fault;
    }
